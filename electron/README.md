# zhima api Electron Desktop App

This directory contains the Electron wrapper for zhima api, providing a native desktop application with system tray support for Windows, macOS, and Linux.
...
- **Production**:
  - macOS: `~/Library/Application Support/zhima api/data/`
  - Windows: `%APPDATA%/zhima api/data/`
  - Linux: `~/.config/zhima api/data/`
